...
define( 'ALM_WOO_VERSION', '1.1.0.1' );
define( 'ALM_WOO_RELEASE', 'February 16, 2021' );
...
function alm_woo_install() {
	if ( ! is_plugin_active( 'ajax-load-more/ajax-load-more.php' ) ) {
		wp_die( __( 'You must install and activate <a href="https://wordpress.org/plugins/ajax-load-more/">Ajax Load More</a> before installing the ALM WooCommerce Add-on.', 'alm-woocommerce' ) );
	}
