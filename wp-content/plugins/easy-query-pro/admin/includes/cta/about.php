<div class="cta">
	<h3><?php _e('About the Plugin', EQ_NAME); ?></h3>
	<div class="cta-wrap config">
		...
		<p>Create queries using our intuitive <a href="options-general.php?page=easy-query&tab=query-builder">Query Builder</a> then place the generated Shortcode or <a href="http://codex.wordpress.org/Class_Reference/WP_Query" target="_blank">WP_Query</a> PHP output directly into your theme templates, content editor or widget area.</p>
