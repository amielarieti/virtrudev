<div class="admin cnkt" id="ewpq-repeaters">
	<div class="wrap">
		<div class="header-wrap">
			<h1><?php echo EQ_TITLE; ?>: <strong><?php _e('Templates', 'easy-query'); ?></strong>
			<em><?php _e('The library of available templates for use throughout your theme', 'easy-query'); ?>.</em></h1>
		</div>
		<div class="cnkt-main repeaters">
		   ...
		   <div class="postbox">
   		   <div class="group no-margin">
   				<span class="toggle-all">
   				   <span class="inner-wrap">
   				      <em class="collapse"><?php _e('Collapse All', 'easy-query'); ?></em>
   				      <em class="expand"><?php _e('Expand All', 'easy-query'); ?></em>
   				   </span>
               </span>
   		            ...
   		            <div class="wrap repeater-wrap" data-name="default" data-type="default">
      		            <div class="one_half">
         			      ...
         			      <input type="text" id="alias-default" class="disabled-input" value="Default" maxlength="55" readonly="readonly">
         				   ...
         				   <div class="one_half">
         			         <label class="template-title" for="id-default">
         			            <?php _e('Template ID', 'easy-query'); ?>:
                           </label>
                           <input type="text" id="alias-default" class="disabled-input" value="default" maxlength="55" readonly="readonly">
         				   </div>

                        <label class="template-title extra-padding" for="template-default">
                  ...
                  *  @since 1.0
                  */
      				do_action('eq_display_templates');
      			?>
   				...
   				<script>
   					jQuery(document).ready(function($) {
   							   ...
   							   btn.addClass('saving');
   								...
   								$.ajax({
   									...
   									error: function(xhr, status, error) {
   										responseText.html('<?php _e('Something went wrong and the data could not be saved.', 'easy-query') ?>').removeClass('loading');
   										btn.removeClass('saving');
   									}
                           });
   							}
   					    ...
   					    */
   						...
   						$('.option-update a').on('click', function(){
   							var btn = $(this);
   		   ...
   		   <div id="major-publishing-actions" class="ewpq-save-settings">
      		   <button type="button" class="button button-large button-primary" id="ewpq-add-template"><i class="fa fa-plus-circle"></i> <?php _e('Add New Template', 'easy-query'); ?></button>
               <div class="clear"></div>
            </div>
