	...
	<div class="wrap">
		<div class="header-wrap">
			<h1>
   			...
   			<em><?php _e('Create your own <a href="http://en.support.wordpress.com/shortcodes/" target="_blank">Shortcode</a> and <a href="http://codex.wordpress.org/Class_Reference/WP_Query" target="_blank">WP_Query</a> by adjusting the parameters below.', 'easy-query'); ?>
   			</em>
			</h1> 
		</div>
